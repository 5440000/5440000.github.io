...
function _createModal({ img, name, price, currancy, madein }) {
  ...
  buttonCart.addEventListener("click", () => {
    $.modalCart({ img, name, price, currancy, madein }).openCssCart;
  });
...
const $ = {
  modal: function (options) {
    //обьявляю метод modal для обьекта доллар и передаю ему options
  ...
  modalCart: function (options) {
    ...
    const modalCart = {
      ...
      closeCssCart() {
        $modalCart.classList.remove("close");
      },
    };
    ...
    <div class="modal-cart__overlay" data-close="true">
        <div class="modal-cart__window">
            ...
            <div class="modal-cart__content">
                <div class="modal-cart__img" style="background= "${img}" "data-close="true"></div>
...
buttonCart.addEventListener("click",showOpenCart 
);
